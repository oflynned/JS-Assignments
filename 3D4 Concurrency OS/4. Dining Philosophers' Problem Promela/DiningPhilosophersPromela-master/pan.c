...
short src_ln2 [] = {
	  0,  44,  45,  43,  51,  52,  53,  50, 
	 56,  57,  55,  59,  49,  62,   0,   0, 
	 63,  67,  68,  69,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "lab4.pml", 1, 13 },
...
{	int j, h = now._nr_pr;
	...
	case 2:	/* reset_philosopher */
		...
		/* locals: */
#ifdef VAR_RANGES
		logval("reset_philosopher:id", ((P2 *)pptr(h))->id);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
...
{	/* int i; */
	...
	case 3:
		...
		break;
	case 2:
		printf("local vars proc %d (reset_philosopher):\n", pid);
	printf("	byte   id:	%d\n", ((P2 *)pptr(pid))->id);
		break;
	case 1:
